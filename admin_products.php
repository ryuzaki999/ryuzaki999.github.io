      ...
      <div class="flex">
         ...
         <select name="category" class="box" required>
            <option value="" selected disabled>เลือกหมวดหมู่</option>
               ...
               <option value="ลูกบาส">ลูกบาส</option>
               <option value="รองเท้าบาส">รองเท้าบาส</option>
...
<section class="show-products">
   ...
   ?>
   <div class="box">
      <div class="price"><?= $fetch_products['price']; ?> บาท/ชั่วโมง</div>
      <img src="uploaded_img/<?= $fetch_products['image']; ?>" alt="">
      <div class="name"><?= $fetch_products['name']; ?></div>
      <div class="cat"><?= $fetch_products['category']; ?></div>
      <div class="details"><?= $fetch_products['details']; ?></div>
      <div class="flex-btn">
         <a href="admin_update_product.php?update=<?= $fetch_products['id']; ?>" class="option-btn">อัปเดต</a>
